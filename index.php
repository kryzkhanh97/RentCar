      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Cho chuyến du lịch trọn vẹn</h1>
            <p>Hàng ngàn loại xe dành cho bạn</p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Tìm loại xe tốt nhất <span>dành cho bạn</span></h2>
...
<li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Số chỗ</li>
</ul>
</div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Cảm nhận của <span>khách hàng</span></h2>
    </div>
    <div class="row">
