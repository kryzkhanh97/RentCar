    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Lịch sử đặt xe</h5>
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>Từ ngày:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>Đến ngày:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
