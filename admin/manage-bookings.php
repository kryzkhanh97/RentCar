...
<head>
	...
	<title>Car Rental Portal | Quản lý đặt xe  </title>
...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Confirm this booking')"> Xác nhận</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this Booking')"> Hủy</a>
</td>
