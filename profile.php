...
<title>Car Rental Portal | Hồ sơ</title>
<!--Bootstrap -->
         ...
         if($msg){?><div class="succWrap"><strong>THÀNH CÔNG</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
              <label class="control-label">Đăng ký ngày -</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Lưu <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
