...
<div class="modal fade" id="forgotpassword">
  ...
  <div class="form-group">
              ...
              <div class="text-center">
                <p class="gray_text">Vì lý do bảo mật, chúng tôi không lưu trữ mật khẩu của bạn. Mật khẩu của bạn sẽ được đặt lại và một mật khẩu mới sẽ được gửi qua email.</p>
