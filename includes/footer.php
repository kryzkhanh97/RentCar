      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <li><a href="page.php?type=terms">Điều khoản</a></li>
               <li><a href="admin/">Dành cho quản lý</a></li>
          </ul>
        </div>
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="newsletter-form">
            ...
            <p class="subscribed-text">*Chúng tôi gửi ưu đãi lớn và tin tức tự động mới nhất cho người dùng đã đăng ký của chúng tôi trong tuần.</p>
          </div>
        </div>
      </div>
    </div>
